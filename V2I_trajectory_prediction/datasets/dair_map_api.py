...
# DATA_ROOT = "/groups/klhead/xic/cyverse_data/"
# DATA_ROOT = "/home/yc27979/mc451742/V2I_trajectory_prediction/V2X-Seq/V2X-Seq-TFD-Example/"
DATA_ROOT = "/home/yc27979/mc451742/V2I_trajectory_prediction/V2X-Seq/V2X-Seq-TFD/V2X-Seq-TFD"
...
class DAIRV2XMap(ArgoverseMap):
    ...
    def build_hallucinated_lane_bbox_index(
        ...
        """
        Populate the pre-computed hallucinated extent of each lane polygon, to allow for fast queries.
